...
switch ($divLevel) {
    ...
    case 2:
        $target = 120;
        $table = "divYearThree";
        $sqltwo = "INSERT INTO $table VALUES ('$username', '$divLevel', '$timeStamp', '$totalTime', '$accperc', '$name0', '$name1', '$name2', '$name3', '$name4', '$name5', '$name6', '$name7', '$name8', '$name9', '$name10', '$name11', '$name12', '$name13', '$name14', '$name15', '$name16', '$name17', '$name18', '$name19', '$name20', '$name21', '$name22', '$name23', '$name24', '$name25', '$name26', '$name27', '$name28', '$name29', '$name30', '$name31', '$name32', '$name33', '$name34', '$name35', '$name36', '$name37', '$name38', '$name39', '$name40', '$name41', '$name42', '$name43', '$name44', '$name45', '$name46', '$name47', '$name48', '$name49', '$name50', '$name51', '$name52', '$name53', '$name54', '$name55', '$name56', '$name57', '$name58', '$name59')";
        break;
    case 3:
    case 4:
        $target = 180;
...
if ($seconds <= $target && $acc > 0.97){
  $divLevel++;
  $sql = "UPDATE MyStudents SET divlevel = '$divLevel' WHERE username = '$username'";
  mysqli_query($conn,$sql) or die(mysqli_error($conn));
  echo "Your new level is: " . $divLevel;
} else {
